    ...
    <div style={wrap}>
      <div style={container}>
        ...
        <div style={card}>
          ...
          <p style={p}>
            These Terms govern your use of CloudAxora’s website and services (“Services”). By using our Services,
          ...
          <p style={p}>
            We do not make changes in your AWS environment without your explicit approval. Implementation work, if requested,
            is handled only after confirmation from you.
          </p>

          <h2 style={h2}>4) Your responsibilities</h2>
          <ul>
            <li style={li}>Provide accurate information for the audit request.</li>
            <li style={li}>Ensure you have authorization to grant read-only access or share exports.</li>
            <li style={li}>Review recommendations before applying them.</li>
          </ul>

          <h2 style={h2}>5) Disclaimer</h2>
          <p style={p}>
            Our reports provide best-effort recommendations based on the information available at the time of the a
